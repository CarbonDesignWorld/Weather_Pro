...
function WeatherVisualHero() {
  ...
  return (
    <div className="h-full max-w-[506px] relative rounded-[22px] shrink-0 w-[317px] overflow-hidden shadow-[0px_4px_20px_rgba(28,42,68,0.12)]" data-name="Weather Visual Display">
      <img
